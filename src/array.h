...
static inline int psm__array_check_index(psm_size i, psm_size n)
{
 ...
 * Returns 0 if max <= 0.
 */
static inline psm__i32 psm__clamp_idx(psm__i32 idx, psm__i32 max)
{
  if (max <= 0) return 0;
 ...
 */
static inline psm__i32 psm__safe_order_level(psm__i32 max_do, psm__i32 min_do)
{
  if (max_do < min_do)
    return 0;
  /*
